  ...
  return (
    ...
    >
      <Card variant="bento" className="w-full" glow>
        <div className="mb-8">
          <p className="text-white text-[10px] font-bold uppercase tracking-[0.3em] mb-2">// Sign in</p>
          <h2 className="text-3xl font-heading font-extrabold uppercase tracking-tight">Oversight Portal</h2>
        </div>
